...
use WPMUDEV\PluginTest\App\Endpoints\V1\Auth_Confirm;
...
class Auth extends Base {
	...
	public function register_admin_page() {
		$page = add_menu_page(
			__( 'Google Auth setup', 'wpmudev-plugin-test' ),
			$this->page_title,
			'manage_options',
			$this->page_slug,
			array( $this, 'callback' ),
	...
	public function prepare_assets() {
		...
		$this->page_scripts[ $handle ] = array(
			...
			'localize'  => array(
				...
				'auth_endpoint'     => $site_url.'/wp-json/wpmudev/v1/auth/auth-url',
	 ...
	 * @return void
	 */
	public function enable_cookie_authentication()
	{
		add_filter('rest_cookie_check_errors', '__return_false');
	}
}
