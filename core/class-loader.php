...
use WPMUDEV\PluginTest\App\Shortcode\Login;
...
final class Loader extends Base {
	...
	private function init() {
		add_option( WPMUDEV_PLUGINTEST_SETTINGS, '' );
		Auth::instance()->init();
		Post_Maintenance::instance()->init();
		\WPMUDEV\PluginTest\App\Endpoints\V1\Auth::instance();
		Login::instance()->init();
	}
}
